...
<h3 align="center">
  Aplicação frontend para gerenciar seus processos e pareceres.
</h3>
...
```bash
$ git clone https://github.com/sibelly/softplan-desafio-fullstack-sibelly-cavalcante.git && cd front-gerenciar-projetos
```
